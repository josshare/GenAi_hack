...
class IncidentProcessor:
    ...
    def _determine_severity_from_alarm(self, alarm_name: str, alarm_state: str) -> Severity:
    ...
    def _update_incident_status(self, incident: Incident, result: Dict[str, Any]) -> None:
        ...
        try:
            ...
            self.incidents_table.update_item(
                ...
                UpdateExpression='SET #status = :status, #actions_taken = list_append(#actions_taken, :action)',
    ...
    def get_incident_history(self, service: str, hours_back: int = 24) -> List[Dict[str, Any]]:
...
def cloudwatch_alarm_handler(event: EventBridgeEvent, context: LambdaContext) -> Dict[str, Any]:
...
@logger.inject_lambda_context
@tracer.capture_lambda_handler
def custom_event_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
...
@logger.inject_lambda_context
@tracer.capture_lambda_handler
def incident_api_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
